...
namespace XnTools {
	...
	/// <summary>
	/// InfoComponent allows the inclusion of instructions or other information as a Component on
	/// any GameObject. Hold option/alt or use : menu command to edit it.
	/// </summary>
	public class InfoComponent : MonoBehaviour {
		...
		[TextArea( 1, 10 )]
		public string text = "Set the <i>Inspector</i> to <b>Debug</b> mode to edit this text.";
	}
		...
		public override void OnInspectorGUI() {
			...
			if ( showDefaultInspector || altHeld ) {
				showDefaultInspector =
					EditorGUILayout.ToggleLeft( "Show Default Inspector…", showDefaultInspector );
			}
			...
			GUILayout.BeginVertical();
			{
				...
				{
					if ( info.icon != null ) {
						GUILayout.Label( info.icon, GUILayout.Width( m_TitleStyle.lineHeight ),
							GUILayout.Height( m_TitleStyle.lineHeight ) );
					}
